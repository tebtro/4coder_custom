// @keycode_missing
//
// @note: KeyCode combinations to get certain KeyCodes

#define Bind_KeyCode_OpenParenthesis(f)  Bind(f, KeyCode_8, KeyCode_Shift);
#define Bind_KeyCode_OpenBracket(f)  Bind(f, KeyCode_8, KeyCode_Alt);


/*  just wtf are cpp macros doing

#define KeyCode_OpenParenthesis   KeyCode_8, KeyCode_Shift
#define KeyCode_CloseParenthesis  KeyCode_9, KeyCode_Shift

#define KeyCode_OpenBrace   KeyCode_7, KeyCode_Alt
#define KeyCode_CloseBrace  KeyCode_0, KeyCode_Alt

#define KeyCode_OpenBracket  KeyCode_8, KeyCode_Alt
#define KeyCode_CloseBracket  KeyCode_9, KeyCode_Alt

#define KeyCode_Hashtag  KeyCode_ForwardSlash
#define KeyCode_DoubleQuote  KeyCode_2, KeyCode_Shift
#define KeyCode_SingleQuote  KeyCode_ForwardSlash, KeyCode_Shift
#define KeyCode_Plus  KeyCode_Equal
#define KeyCode_Star  KeyCode_Equal, KeyCode_Shift
#define KeyCode_QuestionMark  KeyCode_LeftBracket, KeyCode_Shift


#define _KeyCode_ForwardSlash  KeyCode_7, KeyCode_Shift
#define _KeyCode_BackwardSlash  KeyCode_LeftBracket
*/


/*
            for (int keycode = 0; keycode <= 48; ++keycode) {
...
*/
CUSTOM_COMMAND_SIG(vim_keycode_test) {
...
vim_setup_mapping(Mapping *mapping) {
    ...
    vim_define_command("write", vim_save_buffer);
    vim_define_command("wa",    vim_save_all_dirty_buffers);
    ...
    */
    SelectMap(mapid_vim_movements);
    {
        ...
        Bind(vim_search_token_or_word,         KeyCode_Equal); // KeyCode_Plus
    ...
    SelectMap(mapid_vim_mode_visual);
    {
        ...
        */
        ...
        // :surround
        Bind(vim_visual_surround_with_parenthesis, KeyCode_8, KeyCode_Shift); // KeyCode_OpenParenthesis
        Bind(vim_visual_remove_surrounding_parenthesis, KeyCode_9, KeyCode_Shift); // KeyCode_CloseParenthesis
        
        Bind(vim_visual_surround_with_braces,      KeyCode_7, KeyCode_Alt); // KeyCode_OpenBrace
        Bind(vim_visual_remove_surrounding_braces, KeyCode_0, KeyCode_Alt); // KeyCode_CloseBrace
        
        Bind(vim_visual_surround_with_brackets,      KeyCode_8, KeyCode_Alt); // KeyCode_OpenBracket
        Bind(vim_visual_remove_surrounding_brackets, KeyCode_9, KeyCode_Alt); // KeyCode_CloseBracket
        
        Bind(vim_visual_surround_with_static_if,      KeyCode_ForwardSlash); // KeyCode_Hashtag
        Bind(vim_visual_remove_surrounding_static_if, KeyCode_ForwardSlash, KeyCode_Control); // KeyCode_Hashtag, KeyCode_Control
        
        Bind(vim_visual_surround_with_double_quotes,        KeyCode_2, KeyCode_Shift); // KeyCode_DoubleQuote
        Bind(vim_visual_remove_surround_with_double_quotes, KeyCode_2, KeyCode_Shift, KeyCode_Control); // KeyCode_DoubleQuote, KeyCode_Control
        
        Bind(vim_visual_surround_with_single_quotes,        KeyCode_ForwardSlash, KeyCode_Shift); // KeyCode_SingleQuote
        Bind(vim_visual_remove_surround_with_single_quotes, KeyCode_ForwardSlash, KeyCode_Shift, KeyCode_Control); // KeyCode_SingleQuote, KeyCode_Control
        
        Bind(vim_visual_comment_line_range,   KeyCode_7, KeyCode_Shift); // KeyCode_ForwardSlash
        Bind(vim_visual_uncomment_line_range, KeyCode_7, KeyCode_Shift, KeyCode_Control); // KeyCode_BackwardSlash, KeyCode_Control
        Bind(vim_visual_surround_with_comment,        KeyCode_Equal, KeyCode_Shift); // KeyCode_Star
        Bind(vim_visual_remove_surround_with_comment, KeyCode_Equal, KeyCode_Shift, KeyCode_Control); // KeyCode_Star, KeyCode_Control
    }
